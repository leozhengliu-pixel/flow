...
import { Building2, FileText, FolderKanban, Layers3, Lightbulb, Rocket, Search, SlidersHorizontal, UserRound, X } from 'lucide-react'
...
function SearchResultIcon({ result }: { result: SearchResult }) {
  ...
  if (result.type === 'release') return <span className="workspace-search-result-icon"><Rocket/></span>
