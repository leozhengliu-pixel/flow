...
export function DropdownMenuCheckboxItem({children,checked,...props}:P.DropdownMenuCheckboxItemProps){return <P.CheckboxItem className="menu-item" checked={checked} {...props}><span className="menu-indicator"><P.ItemIndicator><Check size={13}/></P.ItemIndicator></span>{children}</P.CheckboxItem>}
