...
describe('DeployPreviews', () => {
  it('links ready previews to the deployment and in-progress ones to their logs, hiding inactive', () => {
    ...
    expect(screen.getByRole('link', { name: /Preview.*Preview ready/ })).toHaveAttribute('href', 'https://store-git-fix.vercel.app')
    expect(screen.getByRole('link', { name: /Storybook.*Preview building/ })).toHaveAttribute('href', 'https://app.netlify.com/logs')
