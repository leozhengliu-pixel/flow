...
export function ProjectAssociationPicker({ children, initiative, projects, onUpdate, label = 'Add project' }: {
  ...
  return <Popover.Root open={open} onOpenChange={setOpen}>
    ...
    <Popover.Portal><Popover.Content data-flow-motion="floating" align="end" className="li-project-picker" collisionPadding={8} sideOffset={4} onOpenAutoFocus={event => event.preventDefault()}>
