...
import type { FlowDocument, InitiativeResource } from '@/types/flow'
import { createDocument } from '@/lib/api'
import { DocumentGlyph } from '@/components/documents/document-icon'

export function InitiativeResources({ documents, initiativeId, resources, onCreate, onUpdate, onDelete }: {
