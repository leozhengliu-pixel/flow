...
import { Check, ChevronDown, ChevronRight, Copy, Edit3, Filter, Link2, MoreHorizontal, Paperclip, PanelRightClose, PanelRightOpen, Plus, Send, SlidersHorizontal, Sparkles, Star, Trash2 } from 'lucide-react'
...
function InitiativeSidebar({ initiative, users, teams, labels, labelGroups, projects, projectUpdates, viewer, update, onTabChange }: Props & { update: (input: InitiativeMutationInput) => Promise<Initiative> }) {
